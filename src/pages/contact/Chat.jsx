...
💬 Pesan: ${message}`;
  ...
  return (
    <div id="chat" className="relative lg:pt-20 xl:pt-20 md:pt-20 min-h-screen flex flex-col bg-gradient-to-b from-blue-300 via-purple-100 to-pink-100 dark:bg-gradient-to-b dark:from-indigo-900 dark:via-cyan-800 dark:to-purple-900 dark:text-white">
      <Navbar />
