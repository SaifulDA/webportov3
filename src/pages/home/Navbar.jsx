...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <footer className="fixed bottom-0 left-0 w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-t border-gray-300 dark:border-gray-700 shadow-lg md:hidden flex justify-around py-3">
        {/* Home */}
