import { loginToSpotify } from '../../services/SpotifyApi';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-br from-black to-gray-900">
      <div className="text-center max-w-md mx-auto">
        ...
        <button
          ...
          className="bg-green-500 hover:bg-green-400 text-white px-8 py-3 rounded-full font-semibold flex items-center justify-center space-x-2 transition-colors duration-300"
        >
